...
*Create a file named `requirements.txt` to help others install libraries easily.*
...
*Create a file named `.gitignore` to prevent uploading unnecessary system files.*
